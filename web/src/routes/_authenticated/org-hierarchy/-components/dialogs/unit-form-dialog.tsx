...
import {
  createUnitMutationOpts,
  unitTreeQueryOpts,
  updateUnitMutationOpts,
} from "@/api/units.ts";
...
export function UnitFormDialog() {
  ...
  const form = useForm<UnitFormData>({
    ...
    defaultValues: {
      ...
      description:
        mode === "edit" && editingUnit ? editingUnit.description || "" : "",
      parent_unit_id:
        mode === "edit" && editingUnit ? editingUnit.parent_unit_id : undefined,
    },
  });
...
const TreeNodeSelector = memo(function TreeNodeSelector({
  node,
  selectedId,
  disabledIds,
  onSelect,
