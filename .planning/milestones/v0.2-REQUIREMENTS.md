# Requirements Archive: v0.2 Ontology Extension — Origins, Tickets & Coverage + Direction
...
| UXFD-02 | Phase 15 | Partial — contract drafted; stale applies-to 16–26; amend in v0.2.1 |
| AVAIL-03 | (cancelled Phase 16 FE) | Dropped — v0.2.1 job-shaped input |
| AVAIL-04 | (cancelled Phase 16 FE) | Dropped — v0.2.1 job-shaped input |
| AVAIL-05 | (cancelled Phase 16 FE) | Dropped — v0.2.1 job-shaped input |
| SURF-01 | (cancelled Phase 17) | Dropped — v0.2.1 job-shaped input |
| SURF-02 | (cancelled Phase 17) | Dropped — v0.2.1 job-shaped input |
| SURF-03 | (cancelled Phase 17) | Dropped — v0.2.1 job-shaped input |
| SURF-04 | (cancelled Phase 17) | Dropped — v0.2.1 job-shaped input |
| SURF-05 | (cancelled Phase 17) | Dropped — v0.2.1 job-shaped input |
| SURF-06 | (cancelled Phase 18) | Dropped — v0.2.1 job-shaped input |
| TICK-06 | (cancelled Phase 18) | Dropped — v0.2.1 job-shaped input |
| SURF-07 | (cancelled Phase 19) | Dropped — v0.2.1 job-shaped input |
| SURF-08 | (cancelled Phase 19) | Dropped — v0.2.1 job-shaped input |
| POLS-01 | (cancelled Phase 20) | Dropped — v0.2.1 job-shaped input |
| POLS-02 | (cancelled Phase 21) | Dropped — v0.2.1 job-shaped input |
| POLS-03 | (cancelled Phase 21) | Dropped — v0.2.1 job-shaped input |
| POLS-06 | (cancelled Phase 22) | Dropped — v0.2.1 job-shaped input |
| POLS-04 | (cancelled Phase 23) | Dropped — v0.2.1 job-shaped input |
| POLS-05 | (cancelled Phase 23) | Dropped — v0.2.1 job-shaped input |
| POLS-07 | (cancelled Phase 24) | Dropped — v0.2.1 job-shaped input |
| POLS-08 | (cancelled Phase 24) | Dropped — v0.2.1 job-shaped input |
| POLS-09 | (cancelled Phase 25) | Dropped — v0.2.1 job-shaped input |
| POLS-10 | (cancelled Phase 25) | Dropped — v0.2.1 job-shaped input |
| POLS-11 | (cancelled Phase 26) | Dropped — v0.2.1 job-shaped input |

**Coverage:**

- v0.2 requirements: 47 total
- Shipped: 23 (FND-01..04, TICK-01..05, COV-01..05, DIR-01..06, AVAIL-01..02, UXFD-01)
- Partial: 1 (UXFD-02 — sketch-loop contract exists at 00a9cd6; file still stale vs 2026-08-23 amendment)
- Dropped as route/page work, retained as historical inputs for v0.2.1 job clusters: 23 (TICK-06, AVAIL-03..05, SURF-01..08, POLS-01..11)

## Outcomes at v0.2 close (2026-08-25)

v0.2 shipped the ontology backends (Phases 11–14), UX foundation tokens/components (Phase 15), and integrity repair (Phase 16). Route-oriented Phases 17–26 were **never started** and are **cancelled**. Unchecked presentation requirements are **not** v0.2 completion blockers and must **not** be copied blindly into v0.2.1 as page/route phases.

- Do not recreate Phases 17–26.
- Do not treat SURF-*/POLS-*/AVAIL-03..05/TICK-06 as live route work.
- UXFD-02 is not closed by running a sketch session; amend `SKETCH-LOOP-CONTRACT.md` only if ambiguity remains after the v0.2.1 contract/composition sequence.
- Customer portal remains out of scope (D-E). Customer contract in v0.2.1 may conclude “no app surface”.
...
*Last updated: 2026-08-25 at milestone v0.2 close*
