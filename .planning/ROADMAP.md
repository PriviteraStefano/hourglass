...
**Status:** Complete — 8/8 plans executed (incl. 3/3 gap-closure plans 09-06/07/08)
...
| [x] 09-06 | Gap fix: kind='phase' forward migration 013 (subproject-derived activities) + migration-test surgery (completed 2026-07-31) | 3 | 2 | 4 |
| [x] 09-07 | Gap fix: working_group integration test re-seed onto activities (completed 2026-07-31) | 3 | 1 | 1 |
| [x] 09-08 | Gap fix: cycle prevention on activities.parent_id (ErrActivityCycle + validateParent + 400 mapping) (completed 2026-07-31) | 3 | 2 | 5 |
...
**Status:** In progress — 1/6 plans executed (10-01: frontend activities API layer, `/projects` → `/activities` rename, e2e green)
